...
# In production, you’d store problems server-side with the correct answer.
# For now, we’ll generate problems deterministically and verify in-memory rules.
...
def generate_problem(grade: int, difficulty: int) -> dict:
    # You can expand this by grade: subtraction, multiplication, division, etc.
